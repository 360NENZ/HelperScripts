...
from define_pb2 import QueryCurrRegionHttpRsp
...
if __name__ == '__main__':
  parser = ArgumentParser(description = "Fetches, decrypts and parses QueryCurrRegionHttpRsp")
  parser.add_argument('url', type=str, help="URL to fetch response from; key for decryption will be derived directly from qs")
